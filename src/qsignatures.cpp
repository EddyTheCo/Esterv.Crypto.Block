...
Ed25519_Signature::Ed25519_Signature(const public_key &public_key_m, const signature &signature_m):Signature(Ed25519_typ),public_key_(public_key_m),signature_(signature_m){};
