...
NFT_Address::NFT_Address(c_array nft_id_m):Address(NFT_typ,nft_id_m){};
...
Alias_Address::Alias_Address(c_array alias_id_m):Address(Alias_typ,alias_id_m){};
...
Ed25519_Address::Ed25519_Address(c_array pubkeyhash_m):Address(Ed25519_typ,pubkeyhash_m){};
