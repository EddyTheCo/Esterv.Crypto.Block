...
Unlock_Condition::Unlock_Condition(types typ, const std::shared_ptr<const class Address> &address_m ):type_m(typ),address_(address_m){};
...
Address_Unlock_Condition::Address_Unlock_Condition(QDataStream &in):Unlock_Condition(Address_typ,Address::from_<QDataStream>(in)){};



std::shared_ptr<const Unlock_Condition> Unlock_Condition::State_Controller_Address(const std::shared_ptr<const class Address> &address_m)
{
    return std::shared_ptr<Unlock_Condition>(new State_Controller_Address_Unlock_Condition(address_m));
}

State_Controller_Address_Unlock_Condition::State_Controller_Address_Unlock_Condition(const std::shared_ptr<const class Address> &address_m):
...
std::shared_ptr<const Unlock_Condition> Unlock_Condition::Governor_Address(const std::shared_ptr<const class Address> &address_m)
{
...
Governor_Address_Unlock_Condition::Governor_Address_Unlock_Condition(const std::shared_ptr<const class Address> &address_m):
...
std::shared_ptr<const Unlock_Condition> Unlock_Condition::Immutable_Alias_Address(const std::shared_ptr<const class Address> &address_m)
{
    return std::shared_ptr<Unlock_Condition>(new Immutable_Alias_Address_Unlock_Condition(address_m));
}

Immutable_Alias_Address_Unlock_Condition::Immutable_Alias_Address_Unlock_Condition(const std::shared_ptr<const class Address> &address_m):
...
std::shared_ptr<const Unlock_Condition> Unlock_Condition::Storage_Deposit_Return(const std::shared_ptr<const class Address> &return_address_m,
                                                                                  const quint64 &return_amount_m)
{
    return std::shared_ptr<Unlock_Condition>(new Storage_Deposit_Return_Unlock_Condition(return_address_m,return_amount_m));
}
Storage_Deposit_Return_Unlock_Condition::Storage_Deposit_Return_Unlock_Condition(const std::shared_ptr<const class Address> &return_address_m, const quint64 &return_amount_m)
...
Timelock_Unlock_Condition::Timelock_Unlock_Condition(const quint32& unix_time_m):Unlock_Condition(Timelock_typ),unix_time_(unix_time_m)
{};
...
std::shared_ptr<const Unlock_Condition> Unlock_Condition::Expiration(const quint32& unix_time_m,
...
Expiration_Unlock_Condition::Expiration_Unlock_Condition(const quint32& unix_time_m, const std::shared_ptr<const class Address> &return_address_m):
