...
QJsonObject Token_Scheme::get_Json(void) const
{
    return QJsonObject();
};
...
std::shared_ptr<Token_Scheme> Token_Scheme::Simple(const quint256 &minted_tokens_m, const quint256 &melted_tokens_m,
...
Simple_Token_Scheme::Simple_Token_Scheme(const quint256 &minted_tokens_m, const quint256 &melted_tokens_m,
                                         const quint256 &maximum_supply_m)
    : Token_Scheme(Simple_typ), minted_tokens_(minted_tokens_m), melted_tokens_(melted_tokens_m),
      maximum_supply_(maximum_supply_m){};
