...
/*!
 * \brief Binary data. A leading uint16 denotes its length. Used in https://github.com/iotaledger/tips/blob/main/tips/TIP-0018/tip-0018.md#metadata-feature
*/
using dataf = fl_array <quint16>;

/*!
 * \brief Binary data. A leading uint32 denotes its length. Used in https://github.com/iotaledger/tips/blob/main/tips/TIP-0023/tip-0023.md#serialized-layout
*/
using dataF = fl_array<quint32>;

/*!
 * \brief The tag of the data. A leading uint8 denotes its length. Used in https://github.com/iotaledger/tips/blob/main/tips/TIP-0018/tip-0018.md#tag-feature
*/
